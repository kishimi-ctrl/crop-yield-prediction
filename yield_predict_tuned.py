...
ax1.set_title('Feature Importance (Tuned Random Forest)', fontsize=14, fontweight='bold')
plt.tight_layout()
...
ax2.scatter(y_test, y_test_pred, alpha=0.6, edgecolors='k', linewidth=0.5, c='steelblue')
...
ax4.set_title('Model Performance: Before vs After Tuning', fontsize=14, fontweight='bold')
ax4.set_xticks(x)
...
results_df = pd.DataFrame({
    'Metric': ['Train R²', 'Test R²', 'Test MAE', 'Test RMSE', 'CV R² Mean', 'Overfitting Gap'],
    'Original Model': [0.9357, 0.7607, 3.21, 4.01, 0.733, 0.175],
    'Tuned Model': [train_r2, test_r2, test_mae, test_rmse, cv_scores.mean(), train_r2 - test_r2]
})
